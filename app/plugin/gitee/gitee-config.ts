...
@configClass({
  description: 'The config for Gitee robot',
})
export class GiteeConfig extends HostingConfigBase {

  @configProp({
    description: 'Host of the Gitee platform, temporarily is useless',
    defaultValue: 'https://www.gitee.com',
  })
  host: string;
